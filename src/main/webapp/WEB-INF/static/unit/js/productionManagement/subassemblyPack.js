//半成品 JS
$(function () {
    var $table = $('#subassemblyPackTable');
    ...
    //查询
    $("#subassemblyPack_btn").on("click",function () {
     ...
     * 确认
     */
    $("#subassemblyPack_btn_ok").on("click",function (e) {
        //工单ID
        ...
        $.ajax({
            type : 'post',
            url : basePath + 'subassemblyPackController/savePackingNumber',
            data : {
    ...
    $("#print_btn").on("click",function () {
        //获取选中的行
        var selections = $('#subassemblyPack2Table').bootstrapTable('getSelections');
        ...
        $.ajax({
            type : 'post',
            url : basePath + 'subassemblyPackController/printerPacking',
            data : {
...
function getDataTable(refresh) {
    var url = basePath + 'subassemblyPackController/queryAll';
    var $table = $('#subassemblyPackTable');
...
function getDataTablePacking(refresh) {
    var url = basePath + 'subassemblyPackController/queryPackingAll';
    var $table = $('#subassemblyPack2Table');
    if(eGdUtil.isEmpty(refresh)){
        $table.bootstrapTable({
            queryParams : function(params) {
                return {
