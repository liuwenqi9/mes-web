        ...
        <div class="col-xs-12">
            ...
            <!-- 无工单借机条码的补打 --> 
              <%--  <div style="width: 100%;margin-top: 50px;padding-bottom: 30px;">
                ...
                <!-- update 修改条码状态，为 符合借机-->
                <span style="font-size:18px;font-weight: bold;">导入产品条码:</span>
                <table cellspacing="0" style="width: 100%;margin-top: 20px;" id="JJNoProductBarcode">
                <thead>
                <tr>
                	<th style="text-align: center; width: 130px;height: 50px; font-size:14px;font-weight: bold;">操作类型</th>
                    ...
                    <th style="text-align: center; width: 130px;height: 50px; font-size:14px;font-weight: bold;">子库</th>
                    <th style="text-align: center; width: 130px;height: 50px; font-size:14px;font-weight: bold;">货位</th>
                ...
                <tr style="text-align: center; width: 150px;height: 30px;">
               		 <td >
                         <select class="form-control" name="type_type" style="margin-left:18px;width: 150px;"  onchange="typeChange(this);" >  
                          <!--   <option value=''>---请选择---</option> -->
                            
                        </select>
                    </td>
                	<td >
                        <input name="barcodeText" class="form-control" style="margin-left:18px;width: 150px;"/> 
                    </td>
                    <td>
                        <input name="segment1" class="form-control" style="margin-left:18px;width: 150px;" onblur="codeBlur(this);"/> 
                    	<input type="hidden" name="inventoryItemId">
                    </td>
                    <td>
                        <input name="prodType" class="form-control" style="margin-left:18px;width: 150px;" readonly />                    	
                    </td> 
                    <td >
                        <select class="form-control" name="sourceSubLibrary" style="margin-left:18px;width: 150px;" onchange="sourceSubLibraryChange(this);" >
                            
                        </select>
                    </td>
                    <td >
                        <select class="form-control" name="sourceLocation" style="margin-left:18px;width: 150px;" > 
