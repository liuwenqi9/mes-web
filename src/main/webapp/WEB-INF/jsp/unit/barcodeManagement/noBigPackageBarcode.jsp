...
<head>
    ...
    <script type="text/javascript" charset="UTF-8" src="${pageContext.request.contextPath}/static/unit/js/barcodeManagement/noBigPackageBarcode.js"></script>
            ...
            <div class="box">
                <form class="form-inline" style="margin-top: 10px;">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="barcodeType" value="大包装条码" disabled="disabled"/>
                    </div>
                    <div class="form-group">
                ...
                <div style="width: 100%;margin-top: 50px;padding-bottom: 30px;">
                    ...
                    <div style="width: 100%;">
                        <form class="form-inline" style="margin-top: 10px;">
                            ...
                            <span style="font-size: 12px;color: green;" id="dataRefresh"></span>
                        </form>
                    </div>
                </div>
            </div>
