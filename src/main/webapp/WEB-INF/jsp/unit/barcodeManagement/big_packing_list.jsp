...
<head>
    ...
    <script type="text/javascript" charset="UTF-8" src="${pageContext.request.contextPath}/static/unit/js/barcodeManagement/big_packing_list.js"></script>
            ...
            <div class="box">
                <div class="form-inline" style="margin-top: 10px;">
                    <div class="form-group">
                        <label for="big_barcode_text">大包装箱</label>
                        <input type="text" class="form-control" id="big_barcode_text" placeholder="大包装箱" />
                ...
                <div style="width: 100%;margin-top: 10px;" align="right">
                    <button type="button" class="btn btn-success btn-sm" id='print_btn' data-backdrop="static" />
                        &nbsp;&nbsp;条码打印&nbsp;&nbsp;
                    </button>
                </div>
                <table id="bigPackingTable"></table>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-inline" style="margin-bottom: 10px;">
                    <input type="hidden" id="big_id" value="" />
                    <button type="button" class="btn btn-success btn-sm" id='print_btn2' data-backdrop="static" />
                    &nbsp;&nbsp;条码打印&nbsp;&nbsp;
                    </button>
                </div>
