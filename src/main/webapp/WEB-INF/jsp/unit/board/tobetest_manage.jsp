...
<head>
    ...
    <script type="text/javascript" charset="UTF-8" src="${pageContext.request.contextPath}/static/unit/js/board/tobeTest_manage.js"></script>
...
<div style="width: 100%;height: 100%;">
    <div style="width: 50%;float: left;padding-right: 10px;">
        <div style="font-size: 18px;font-weight: bold;">待检验：</div>
        <%--待检验--%>
        <table id="tobeTest"></table>
    </div>
    <div style="width: 50%;float: left;padding-left: 5px;">
        <div style="font-size: 18px;font-weight: bold;">待入库：</div>
        <table id="tobeStorage"></table>
    </div>
</div>
