...
<head>
    ...
    <script type="text/javascript" charset="UTF-8" src="${pageContext.request.contextPath}/static/unit/js/board/stocking_manage.js"></script>
...
<div style="width: 100%;height: 100%;">
    <div style="width: 50%;float: left;padding-right: 10px;">
        ...
        <table id="to_stocking"></table>
    </div>
    <div style="width: 50%;float: left;padding-left: 10px;">
        <div style="font-size: 18px;font-weight: bold;">待发货：</div>
        <table id="to_delivery"></table>
    </div>
</div>
