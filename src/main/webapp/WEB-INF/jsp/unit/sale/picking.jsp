...
<head>
    ...
    <script type="text/javascript" charset="UTF-8" src="${pageContext.request.contextPath}/static/unit/js/sale/picking.js"></script>
            ...
            <div class="box">
                <div class="form-inline" style="margin-top: 10px;">
                    <div class="form-group" style="margin-left: 20px;">
                        <label for="pickingNum">挑库单</label>
                        <input type="text" class="form-control" id="pickingNum" placeholder="挑库单" />
                    </div>
                    <div class="form-group" style="margin-left: 20px;">
                        <label>搬运单日期：</label>
                    ...
                    <button type="button" class="btn btn-info btn-sm" id='picking_search_btn' data-backdrop="static" style="margin-left: 10px;"/>
                ...
                <table id="pickingDataTable"></table>
            </div>
        </div>
    </div>
</section>
