...
<head>
    ...
    <script type="text/javascript" charset="UTF-8" src="${pageContext.request.contextPath}/static/unit/js/sale/wXOut.js"></script>
            ...
            <div class="box"> 
              <div class="form-inline" style="margin-left: 10px;  margin-top: 10px;">
                <div class="form-group" style="margin-left: 10px;">
                        <label for="xx">出货通知单号</label>
                        <input type="text" class="form-control" id="document_num" style="margin-left: 5px; width: 120px;" placeholder="出货通知单号" />
                </div>
                <div class="form-group" style="margin-left: 10px;">
                        <label for="xx">MO单</label>
                        <input type="text" class="form-control" id="cust_po_number" style="margin-left: 5px; width: 120px;" placeholder="MO单" />
                </div> 
                 <div class="form-group" style="margin-left: 10px;">
                        <label>计划出货日期</label>
                        <input type="text" class="form-control" id="start_date" style="margin-left: 5px; width: 120px;" />
                  </div>
                 <div class="form-group" style="margin-left: 10px;">
                        <label>至&nbsp;&nbsp;</label>
                        <input type="text" class="form-control" id="end_date" style="margin-left: 5px; width: 120px;" />
                 </div>
