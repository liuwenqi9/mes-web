...
<head>
    ...
    <script type="text/javascript" charset="UTF-8" src="${pageContext.request.contextPath}/static/unit/js/sale/pickingCheckDataTable.js"></script>
            ...
            <div class="box">
                <div class="form-inline" style="margin-top: 10px;">
                    ...
                    <div class="form-group" style="margin-left: 20px;">
                        ...
                        <select type='text' class="form-control" id='checkType'>
                            <option value="">---请选择---</option>
                            <option value="no" selected>未包装</option>
                        </select>
                    </div>
                ...
                <table id="pickingCheckDataTable"></table>
            </div>
        </div>
    </div>
</section>
