...
<head>
    ...
    <script type="text/javascript" charset="UTF-8"
            src="${pageContext.request.contextPath}/static/unit/js/reportManagement/stockInStatistic.js"></script>
    <link rel="stylesheet"
            ...
            <div class="box">
                <div class="form-inline" style="margin-top: 10px;">
                    ...
                    <div class="form-group" style="margin-left: 50px;">
                        ...
                        <input type="text" class="form-control" id="date_from_id" >
                    </div>
                    <div class="form-group" style="margin-left: 50px;">
                        <label for="xx1">至</label>
                        <input type="text" class="form-control" id="date_to_id" >
                    </div>
