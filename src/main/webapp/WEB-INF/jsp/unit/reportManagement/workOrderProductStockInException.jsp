...
<head>
    ...
    <script type="text/javascript" charset="UTF-8"
            src="${pageContext.request.contextPath}/static/unit/js/reportManagement/workOrderProductStockInException.js"></script>
    <link rel="stylesheet"
            ...
            <div class="box">
                <div class="form-inline" style="margin-top: 10px;">
                    <div class="form-group" >
                        <label for="xx1">工单号</label>
                    	<input type='text' class="form-control"style="width: 160px;" id="wip_entity_name" />
                    </div> 
