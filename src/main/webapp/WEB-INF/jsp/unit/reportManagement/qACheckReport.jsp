...
<head>
    ...
    <script type="text/javascript" charset="UTF-8"
            src="${pageContext.request.contextPath}/static/unit/js/reportManagement/qACheckReport.js"></script>
    <link rel="stylesheet"
            ...
            <div class="box">
                <div class="form-inline" style="margin-top: 10px;">
                	<div class="form-group">
                        <label for="xx1">生产线</label>
                    	<select type='text' class="form-control" style=" width:130px;" id="line_code"></select>
                    </div>
                    <div class="form-group" style="margin-left: 20px;">
                        <label for="xx1">送检单</label>
                    	<input type='text' class="form-control"  style=" width:120px;" id="inspect_number"/> 
                    </div> 
                    <div class="form-group" style="margin-left: 20px;">
                        <label for="xx1">日期</label>
                        <input type="text" class="form-control"  style=" width:100px;" id="check_date_start" >
                    </div>
                    <div class="form-group" style="margin-left: 0px;">
                        <label for="xx1">至</label>
                        <input type="text" class="form-control" style=" width:100px;" id="check_date_end" >
                    </div>
