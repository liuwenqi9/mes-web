...
<script type="text/javascript" charset="UTF-8"
	src="${pageContext.request.contextPath}/static/unit/js/inventoryManagement/iterationSummary.js"></script>
	...
	<section class="content">
		<!-- panel2 --> 
			<div class="panel panel-default">
					<div class="panel-heading"> <h3 class="panel-title">盘点汇总信息：</h3></div>
					<div class="box"> <br/><br/>
						<!-- summarytable -->
