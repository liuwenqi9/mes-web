...
<head>
    ...
    <script type="text/javascript" charset="UTF-8" src="${pageContext.request.contextPath}/static/unit/js/productionManagement/subassemblyPack.js"></script>
                    ...
                    <div class="col-xs-12">
                        <div class="box" style="height: 200px;">
                            <div class="form-inline" style="margin-top: 10px;margin-bottom: 10px;">
                                ...
                                <button type="button" class="btn btn-info btn-sm" id='subassemblyPack_btn' data-backdrop="static"/>
                                <i class="glyphicon glyphicon-search"></i>查询
                                </button>
                            </div>
                            <table id="subassemblyPackTable"></table>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="col-xs-12">
                        <div class="box" style="height: 200px;">
                            ...
                            <div style="position: absolute;bottom: 3px;right:3px;width: 100%;" align="right">
                                <button type="button" class="btn btn-info btn-sm" id='subassemblyPack_btn_ok' data-backdrop="static"/>
    ...
    <div style="width: 100%;clear: both;position: relative;top: -10px;">
        <section class="content" style="padding: 10px;">
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        <table id="subassemblyPack2Table"></table>
