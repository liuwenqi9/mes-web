...
<head>
	...
	<script type="text/javascript" charset="UTF-8" src="${pageContext.request.contextPath}/static/unit/js/productionManagement/stockInPrinter.js"></script>
		...
		<div class="col-xs-12">
			<div class="box">
				<div class="form-inline" style="margin-top: 10px;">
					...
					<div class="form-group" style="margin-left: 20px;">
						<label>检验时间：</label>
						<input type="text" class="form-control" id="checkBeginDate" />
					</div>
					<div class="form-group" style="margin-left: 5px;"> 
					<label>至</label>
						<input type="text" class="form-control" id="checkEndDate" />
					</div>
					<div style="width: 100%;margin-top: 10px;">
						<div class="form-group">
							<label for="stockInIdentify">入库单标识</label>
							<select class="form-control" id="stockInIdentify">
								<option value='0'>---请选择---</option>
								<option value='Y'>已生成</option>
								<option value='N' selected>未生成</option>
							</select>
						</div>
						<div class="form-group" style="margin-left: 20px;">
							<label for="workOrderNumberSubpool">工单子库</label>
							<input type="text" class="form-control" id="workOrderNumberSubpool" placeholder="工单子库" />
						</div>
					...
					<div style="width: 100%;margin-top: 10px;" align="right">
						<button type="button" class="btn btn-info btn-sm" id='stockInPrinter_generate_btn' data-backdrop="static"/>
						生成入库单
						</button>
					</div>
				</div>
				<table id="stockInPrinterTable"></table>
			</div>
		</div>
	</div>
	</section>
