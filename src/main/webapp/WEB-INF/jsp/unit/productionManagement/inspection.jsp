...
<script type="text/javascript" charset="UTF-8"
	src="${pageContext.request.contextPath}/static/unit/js/productionManagement/inspection.js"></script>
<link rel="stylesheet"
...
<!--[if lt IE 9]>
    ...
    <![endif]-->
<style> 
.setheight{overflow-y:auto; max-height:500px} 
</style> 
</head>
				...
				<div class="box-body table-responsive">
					<div class="form-inline" style="margin-top: 10px;">
						...
						<div class="form-group" style="margin-left: 20px;">
							<label for="search_workOrderNumber">工&nbsp;&nbsp;单&nbsp;&nbsp;号</label>
							<input type="text" class="form-control" id="search_workOrderNumber" placeholder="工单号" />
						</div>
						<div style="width: 100%;margin-top: 10px;">
							<div class="form-group">
								<label for="search_fullPackIdentify">满包标识</label>
								<select class="form-control" id="search_fullPackIdentify" style="margin-left: 15px;">
							...
							<div class="form-group" style="margin-left: 20px;">
								<label for="search_inspectionIdentify">报检标识</label>
								<select class="form-control" id="search_inspectionIdentify">
									<option value=''>---请选择---</option>
									<option value='N' selected="selected">未报检</option>
									<option value='E'>不通过</option>
									<option value='P'>已通过</option>
									<option value='R'>已提交</option>
							...
							<button type="button" class="btn btn-success btn-sm" data-backdrop="static" id="inspection_generate_btn" style="margin-left: 10px;">
								生成报检单
							</button>
						</div>
					</div>
					<div class="setheight">
						<table id="inspectionTable"></table> 
					</div>
					<label class="control-label">
						已勾选箱数：<input style="border:none;background:none" type="text"  id="selectedCount" value="0" readonly>
					</label> 
				</div>
			</div>
		</div>
