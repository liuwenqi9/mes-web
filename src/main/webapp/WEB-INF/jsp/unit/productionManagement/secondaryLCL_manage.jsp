...
<head>
    ...
    <script type="text/javascript" charset="UTF-8" src="${pageContext.request.contextPath}/static/unit/js/productionManagement/secondaryLCL_manage.js"></script>
            ...
            <div class="box">
                <div class="form-inline" style="margin-top: 10px;">
                    <div class="form-group">
                        <label for="packageBarcode">包装条码</label>
                        <input type="text" class="form-control" id="packageBarcode" placeholder="包装条码" style="margin-left: 1em;"/>
                    </div>
                    <div class="form-group" style="margin-left: 20px;">
                        <label for="barcode_text">产品条码</label>
                        <input type="text" class="form-control" id="barcode_text" placeholder="产品条码" />
                    </div>
                    <div class="form-group" style="margin-left: 20px;">
                        <label for="actualNum">实际数量</label>
                        <input type="text" class="form-control" id="actualNum" disabled/>
                    </div>
                    <div style="width: 100%;margin-top: 10px;">
                        <div class="form-group">
                            <label for="surePackageNum">可包装数量</label>
                            <input type="text" class="form-control" id="surePackageNum" disabled />
                        </div>
                        <div class="form-group" style="margin-left: 20px;">
                            <input type="checkbox" class="checkbox" id="relieveLimit" value="Y"/>
                            <label for="relieveLimit">解除限制</label>
                        </div>
                    </div>
                    <div>
                ...
                <table id="secondaryLCLTable"></table>
