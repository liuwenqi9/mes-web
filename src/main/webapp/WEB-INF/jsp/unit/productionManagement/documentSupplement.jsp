...
<script type="text/javascript" charset="UTF-8"
	src="${pageContext.request.contextPath}/static/unit/js/productionManagement/documentSupplement.js"></script>
<link rel="stylesheet"
		...
		<div class="col-xs-12">
			<div class="box">
				<div style="width: 100%;margin-top: 50px;padding-bottom: 30px;">
					<span style="font-size:18px;font-weight: bold;">报检单补打:</span>
					<div style="width: 100%;">
						<div class="form-inline" style="margin-top: 10px;">
							...
							<button type="button" class="btn btn-success btn-sm" style="margin-left: 30px;" id='inspection_generate_btn' data-backdrop="static"/>
							&nbsp;&nbsp;打印&nbsp;&nbsp;
							</button>
						</div>
					</div>
				...
				<div style="width: 100%;margin-top: 50px;padding-bottom: 30px;">
					<span style="font-size:18px;font-weight: bold;">入库单补打:</span>
					<div style="width: 100%;">
						<form class="form-inline" style="margin-top: 10px;">
							...
							<button type="button" class="btn btn-success btn-sm" style="margin-left: 30px;" id='print_stock' data-backdrop="static"/>
							&nbsp;&nbsp;打印&nbsp;&nbsp;
							</button>
						</form>
					</div>
