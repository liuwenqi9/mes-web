...
<script type="text/javascript" charset="UTF-8" src="${pageContext.request.contextPath}/static/egdfrm/js/quartz/cron.js"></script>
<script type="text/javascript" charset="UTF-8" src="${pageContext.request.contextPath}/static/egdfrm/js/quartz/cronTriggersGenerate.js"></script>
<style>
.line {
	height: 25px;
	line-height: 25px;
...
<div class="easyui-layout" data-options="fit:true,border:false" style="border: 1px rgb(202, 196, 196) solid; border-radius: 5px">
		...
		<div class="easyui-tabs" data-options="fit:true,border:false">
			...
			<div title="周" style="">
				...
				<div class="line">
					...
					周期 从星期
					<input class="numberspinner" style="width: 60px;" data-options="min:1,max:7" value="1">
					-
			...
			<div title="年" style="">
				...
				<div class="line">
					...
					周期 从
					<input class="numberspinner" style="width: 90px;" data-options="min:2013,max:3000" value="2013">
					-
	...
	<div data-options="region:'south',border:false,title:'表达式',collapsible:false" style="height: 160px;">
		<table style="height: 100px;">
			...
			<tr>
				<td>Cron表达式:</td>
				<td colspan="7">
					<input type="text" name="cron" style="width: 99%;" value="* * * * * ? " id="cron" readonly="readonly" />
				</td>
			</tr>
		</table>
		<center>
			<a href="#" class="easyui-linkbutton" id="cron_triggers_generate_save_btn">确定</a>
		</center>
	</div>
</div>