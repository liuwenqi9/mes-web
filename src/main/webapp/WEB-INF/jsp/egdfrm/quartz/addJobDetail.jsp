...
<script type="text/javascript" charset="UTF-8" src="${pageContext.request.contextPath}/static/egdfrm/js/quartz/addJobDetail.js"></script>
<form id="job_detail_form_add" name="job_detail_form_add" method="post">
	...
	<table>
		<tr>
			<td>作业名称:</td>
			<td>
				<input id="jName_add" name="jName" style="width: 360px;" />
			</td>
		</tr>
		<tr>
			<td>作业组别:</td>
			<td>
				<input id="jGroup_add" name="jGroup" style="width: 360px;" value="${defaultGroup}" />
			</td>
		</tr>
		<tr>
			<td>作业CLASS:</td>
			<td>
				<input id="jClass_add" name="jClass" style="width: 360px;" />
			</td>
		...
		<tr>
			<td>作业描述:</td>
			<td>
				<input id="jDesc_add" name="jDesc" style="width: 360px;" />
			</td>
		</tr>
		<tr>
			<td>遗漏恢复:</td>
