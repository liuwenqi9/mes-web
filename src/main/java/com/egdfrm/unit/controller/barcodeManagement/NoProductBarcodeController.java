 ...
 */
@Controller
@RequestMapping("noProductBarcode")
public class NoProductBarcodeController {

    @Autowired
    private INoProductBarcodeService iNoProductBarcodeService;
    ...
    public String init(){
        return "unit/barcodeManagement/noProductBarcode";
    }
