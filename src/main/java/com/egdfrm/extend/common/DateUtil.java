...
public class DateUtil {
	...
	/**
	 * 获取日期的时间。yyyy年MM月dd日 HH:mm:ss格式。失败返回null。
	 * 
	 * @param date
	 *            日期
	 * @return 时间
	...
	public static String getDateTimeCN(Date date) {
		return DateToString(date, DateStyle.YYYY_MM_DD_HH_MM_SS_CN);
	}
	...
	public static String getDateTimeCN(String date) {
		return StringToString(date, DateStyle.YYYY_MM_DD_HH_MM_SS_CN);
	}
	/**
	 * 获取日期的星期。失败返回null。
	 * 
