...
public class RSACoder {
	...
	public static Map<String,Object> initKey() throws Exception{
		...
		//System.out.println("CRT COEF："+ privateKey.getCrtCoefficient());  
		//将密钥存储在map中
	 ...
	 * @return byte[] 公钥
	 * */
	public static String getPublicExponent(Map<String,Object> keyMap) throws Exception{
		RSAPublicKey key=(RSAPublicKey) keyMap.get(PUBLIC_KEY);
		return key.getPublicExponent().toString();
	}
	...
	public static byte[] sign(byte[] data,byte[] privateKey) throws Exception{
		...
		//生成私钥
		RSAPrivateCrtKey priKey=(RSAPrivateCrtKey) keyFactory.generatePrivate(pkcs8KeySpec);
		//实例化Signature
