package com.egdfrm.core.model.expand.appconfig;
...
public class LoginPageConfig implements Serializable {
    ...
    public LoginPageConfig() {
        this.loginPageBackgroundImagePath = "egdfrm/img/bg.gif";
        this.loginPageTileBackgroundImagePath = "egdfrm/img/login_1.jpg";
        this.loginPageLogoImagePath = "egdfrm/img/login_2.jpg";
    }
