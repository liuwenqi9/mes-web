 ...
 * Copyright (C) egdfrm.
 */
package com.egdfrm.core.service.quartz;
...
public class QuartzService extends BaseService {
    ...
    public Map<String, Object> schedulerOp(String op, String jn, String jg, String tn, String tg) throws Exception {
        ...
        if ("unscheduleJob".equals(op)) { //移除trigger
            ...
            rv.put(com.egdfrm.core.common.Constants.CODE, com.egdfrm.core.common.Constants.FAIL);
            rv.put(com.egdfrm.core.common.Constants.MESSAGE, "未知操作");
            return rv;
        }
        rv.put(com.egdfrm.core.common.Constants.CODE, com.egdfrm.core.common.Constants.SUCCESS);
        return rv;
    }
    ...
    public Map<String, Object> schedulerClear(String pswd) throws SchedulerException {
        Map<String, Object> rv = null;
        rv = new HashMap<String, Object>();
        if (com.egdfrm.core.common.Constants.SCHEDULER_CLEAR_OP_PSWD.equals(pswd)) {
    ...
    private JobDataMap getJobDataMap(String jobDetailDataMapHid) {
        ...
        if (!org.apache.commons.lang3.StringUtils.isEmpty(jobDetailDataMapHid)
                && !com.egdfrm.core.common.Constants.EMPTY_JOB_MAP_DATA.equals(jobDetailDataMapHid)) {
            ...
            if (!CollectionUtils.isEmpty(dataList)) {
                for (Map<String, String> item : dataList) {
                    ...
                    if (!com.egdfrm.core.common.Constants.DEFAULT_JOB_MAP_NAME.equals(name)
                            && !com.egdfrm.core.common.Constants.DEFAULT_JOB_MAP_VALUE.equals(value))
                        rv.put(name, value);
                }
            }
        }
    ...
    public List<Map<String, Object>> getJobDetail() {
        ...
        SQL.append(" SELECT  ");
        SQL.append(Constants.COL_SCHEDULER_NAME + com.egdfrm.core.common.Constants.COMMA);
        SQL.append(Constants.COL_JOB_NAME + com.egdfrm.core.common.Constants.COMMA);
        SQL.append(Constants.COL_JOB_GROUP + com.egdfrm.core.common.Constants.COMMA);
        SQL.append(Constants.COL_DESCRIPTION + com.egdfrm.core.common.Constants.COMMA);
        SQL.append(Constants.COL_JOB_CLASS + com.egdfrm.core.common.Constants.COMMA);
        SQL.append(Constants.COL_IS_DURABLE + com.egdfrm.core.common.Constants.COMMA);
        SQL.append(Constants.COL_IS_NONCONCURRENT + com.egdfrm.core.common.Constants.COMMA);
        SQL.append(Constants.COL_IS_UPDATE_DATA + com.egdfrm.core.common.Constants.COMMA);
    ...
    public Map<String, Object> getCronTriggerDetail(String sName, String tName, String tGroup) {
        ...
        sql.append(" SELECT  ");
        sql.append(Constants.COL_SCHEDULER_NAME + com.egdfrm.core.common.Constants.COMMA);
        sql.append(Constants.COL_TRIGGER_NAME + com.egdfrm.core.common.Constants.COMMA);
        sql.append(Constants.COL_TRIGGER_GROUP + com.egdfrm.core.common.Constants.COMMA);
        sql.append(Constants.COL_CRON_EXPRESSION + com.egdfrm.core.common.Constants.COMMA);
    ...
    public List<Map<String, Object>> getCronTriggerList(String sName, String jName, String jGroup) {
        ...
        sql = new StringBuffer("");
        sql.append(" SELECT  ");
        sql.append("A." + Constants.COL_SCHEDULER_NAME + com.egdfrm.core.common.Constants.COMMA);
        sql.append("A." + Constants.COL_TRIGGER_NAME + com.egdfrm.core.common.Constants.COMMA);
        sql.append("A." + Constants.COL_TRIGGER_GROUP + com.egdfrm.core.common.Constants.COMMA);
        sql.append("A." + Constants.COL_CRON_EXPRESSION + com.egdfrm.core.common.Constants.COMMA);
    ...
    public List<Map<String, Object>> getSimpleTriggerList(String sName, String jName, String jGroup) {
        ...
        sql.append("A." + Constants.COL_TRIGGER_NAME + com.egdfrm.core.common.Constants.COMMA);
        sql.append("A." + Constants.COL_TRIGGER_GROUP + com.egdfrm.core.common.Constants.COMMA);
        sql.append("A." + Constants.COL_REPEAT_COUNT + com.egdfrm.core.common.Constants.COMMA);
        sql.append("A." + Constants.COL_REPEAT_INTERVAL + com.egdfrm.core.common.Constants.COMMA);
    ...
    public Map<String, Object> getSimpleTriggerDetail(String sName, String tName, String tGroup) {
        ...
        sql.append(Constants.COL_TRIGGER_NAME + com.egdfrm.core.common.Constants.COMMA);
        sql.append(Constants.COL_TRIGGER_GROUP + com.egdfrm.core.common.Constants.COMMA);
        sql.append(Constants.COL_REPEAT_COUNT + com.egdfrm.core.common.Constants.COMMA);
        sql.append(Constants.COL_REPEAT_INTERVAL + com.egdfrm.core.common.Constants.COMMA);
    ...
    public List<Map<String, Object>> getschedulerState() {
        ...
        sql.append(" SELECT ");
        sql.append(Constants.COL_SCHEDULER_NAME + com.egdfrm.core.common.Constants.COMMA);
        sql.append(Constants.COL_INSTANCE_NAME + com.egdfrm.core.common.Constants.COMMA);
        sql.append(Constants.COL_LAST_CHECKIN_TIME + com.egdfrm.core.common.Constants.COMMA);
    ...
    public List<Map<String, Object>> getFiredTriggers() {
        ...
        sql.append(" SELECT ");
        sql.append(Constants.COL_SCHEDULER_NAME + com.egdfrm.core.common.Constants.COMMA);
        sql.append(Constants.COL_ENTRY_ID + com.egdfrm.core.common.Constants.COMMA);
        sql.append(Constants.COL_TRIGGER_NAME + com.egdfrm.core.common.Constants.COMMA);
        sql.append(Constants.COL_TRIGGER_GROUP + com.egdfrm.core.common.Constants.COMMA);
        sql.append(Constants.COL_INSTANCE_NAME + com.egdfrm.core.common.Constants.COMMA);
        sql.append(Constants.COL_FIRED_TIME + com.egdfrm.core.common.Constants.COMMA);
        sql.append(Constants.COL_SCHED_TIME + com.egdfrm.core.common.Constants.COMMA);
        sql.append(Constants.COL_PRIORITY + com.egdfrm.core.common.Constants.COMMA);
        sql.append(Constants.COL_ENTRY_STATE + com.egdfrm.core.common.Constants.COMMA);
        sql.append(Constants.COL_JOB_NAME + com.egdfrm.core.common.Constants.COMMA);
        sql.append(Constants.COL_JOB_GROUP + com.egdfrm.core.common.Constants.COMMA);
        sql.append(Constants.COL_IS_NONCONCURRENT + com.egdfrm.core.common.Constants.COMMA);
        sql.append(Constants.COL_REQUESTS_RECOVERY);
    ...
    public List<Map<String, Object>> getTriggers(String tNameSearch, String tGroupSearch, String jNameSearch,
        ...
        sql.append(") AS " + Constants.COL_DESCRIPTION + com.egdfrm.core.common.Constants.COMMA);

        sql.append(Constants.COL_NEXT_FIRE_TIME + com.egdfrm.core.common.Constants.COMMA);
        sql.append(Constants.COL_PREV_FIRE_TIME + com.egdfrm.core.common.Constants.COMMA);
        sql.append(Constants.COL_PRIORITY + com.egdfrm.core.common.Constants.COMMA);
        sql.append(Constants.COL_TRIGGER_STATE + com.egdfrm.core.common.Constants.COMMA);
        sql.append(Constants.COL_TRIGGER_TYPE + com.egdfrm.core.common.Constants.COMMA);
        sql.append(Constants.COL_START_TIME + com.egdfrm.core.common.Constants.COMMA);
        sql.append(Constants.COL_END_TIME + com.egdfrm.core.common.Constants.COMMA);
        sql.append(Constants.COL_CALENDAR_NAME + com.egdfrm.core.common.Constants.COMMA);
