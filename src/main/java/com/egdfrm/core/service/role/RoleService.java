 ...
 * Copyright (C) egdfrm.
 */
package com.egdfrm.core.service.role;
...
import com.egdfrm.core.mapper.standard.TtRoleMapper;
...
import com.egdfrm.core.model.standard.TtRole;
import com.egdfrm.core.model.standard.TtRoleCriteria;
import com.egdfrm.core.model.standard.TtRoleFunction;
import com.egdfrm.core.model.standard.TtRoleFunctionCriteria;
import com.egdfrm.core.model.standard.TtRoleFunctionKey;
...
public class RoleService extends BaseService {
        ...
        if (ArrayUtils.isNotEmpty(purviewCodeArray)) {
            for (String purviewCode : purviewCodeArray) {
                ...
                if(StringUtils.isEmpty(functionCode)){
    				throw new MesThrowException(CommonExceptionType.ROLE_NOT_LEV3);
                }
                //删除
    ...
    public List<Map<String, Object>> getFunctionList(String roleCode) {
        ...
        //获得角色没有的完整菜单
        List<Map<String, Object>> tree = this.fs.getFunctionPurviewTreeNode(notIncludeFunctionPurviewList, true);
        //返回
        return tree;
    }
    ...
    public List<Map<String, Object>> loadRoleFunctionList(String roleCode) {
        //获得角色已有的功能清单
        List<Map<String, Object>> functionPurviewList = this.ss.findFunctionPurviewByRole(roleCode);
        //获得角色已有的完整菜单
        List<Map<String, Object>> tree = this.fs.loadFunctionPurviewTreeNode(functionPurviewList, true);
        //返回
        return tree;
    }
    /**
    ...
    public JsonResult<String> editRoleNew(TtRole role, String loginName) throws Exception {
        TtRole tr = this.trm.selectByPrimaryKey(role.getRoleCode());
