 ...
 * Created by wangkang
 */
package com.egdfrm.core.service.security;
...
public class SecurityService extends BaseService {
    ...
    public List<String> findUserFunctions(String loginName) {
        ...
        //add by sjf 20161201 start 取职责权限 
        List<String> jobFunctionsList  = ism.findJobFunctionsByLoginName(loginName);
        functionList.addAll(jobFunctionsList);
        //add by sjf 20161201 end 取职责权限 
